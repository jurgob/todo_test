define(["react",  "react_router", "jquery",  "flux" ], function(React, ReactRouter) {
        ...
        render: function () {
            ...
            return (
                React.createElement("div", null, 
                    React.createElement("div", {class: "itemsCompletedCounter"}, "items completed: ", this.props.items.filter(function (el) {
                        return el.done
                    }).length), 
